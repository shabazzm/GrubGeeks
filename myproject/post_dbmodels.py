...
from myproject.dbModels import User_Accounts
...
class Topic(Post):
    ...
    def __init__(self, user_id, post_id, subject, main_post_content, date_created):
        super().__init__(user_id, post_id, date_created)
...
class Reply(Post):
    ...
    def __init__(self, user_id, post_id, subject, reply_content, date_created):
        super().__init__(user_id, post_id, date_created)
